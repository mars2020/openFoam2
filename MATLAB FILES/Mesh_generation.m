...
Blocks = [0 8 9 1 32 40 41 33;     1 9 10 2 33 41 42 34;        
          ...
          6 14 15 7 38 46 47 39;   7 15 8 0 39 47 40 32;
          8 16 17 9 40 48 49 41;   9 17 18 19 41 49 50 51;
          10 9 19 20 42 41 51 52;  11 10 20 21 43 42 52 53;
          23 11 21 22 55 43 53 54; 24 12 11 23 56 44 43 55;
          25 13 12 24 57 45 44 58; 26 27 13 25 58 59 45 57;
          27 28 14 13 59 60 46 45; 28 29 15 14 60 61 47 46;
          29 30 31 15 61 62 63 47; 15 31 16 8 47 63 48 40];
...
for i=0:14
    if i~=7
        ...
        fprintf(file,'\tarc 7 0 (%f %f 0)\n',mid(8,:));
        j = 1;
    end
    j = j+1;
end
fprintf(file,'\tarc 15 8 (%d %d 0)\n',mid(8,:));

j=1;
for i=32:46
    if i~=39
        fprintf(file,'\tarc %d %d',i,i+1);
        fprintf(file,' (%f %f 0.1)\n', mid(j,:));
    else
        fprintf(file,'\tarc 39 32 (%f %f 0.1)\n',mid(8,:));
        j = 1;
    end
    j = j + 1;
end
fprintf(file,'\tarc 47 40 (%f %f 0.1)\n',mid(8,:));
fprintf(file,');\n');
